function Get-KMSActivations {
	<#
	.SYNOPSIS
		A brief description of the Get-KMSActivations function.
	
	.DESCRIPTION
		A detailed description of the Get-KMSActivations function.
	...
	.EXAMPLE
		PS C:\> Get-KMSActivations -ComputerName 'value1'
...
# "HOTH", "KAMINO", "DANTOOINE" | ForEach-Object -Process { Get-KMSActivations -ComputerName $_ -First 1 }
