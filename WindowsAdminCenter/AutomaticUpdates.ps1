...
$history | Microsoft.PowerShell.Core\Where-Object { $_.Operation -eq 1 } | `
Microsoft.PowerShell.Utility\Select-Object `
  Title, `
  ServerSelection, `
  @{Name="InstallState"; Expression={$_.ResultCode}}, `
  @{Name="InstallDate"; Expression={$_.Date}}, `
	@{Name="UpdateID"; Expression={$_.UpdateIdentity | Microsoft.PowerShell.Utility\Select-Object UpdateID} } | `
	Microsoft.PowerShell.Utility\Select-Object -Property * -ExcludeProperty UpdateID -ExpandProperty UpdateID |	`
	Microsoft.PowerShell.Utility\Sort-Object -Property Date -Descending

}
## [END] Get-WindowsUpdateHistory ##
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU4Z7VE5ANFzqLgWuIdqb7sRqs
# 4vygghhuMIIE3jCCA8agAwIBAgITMwAAAP3H8MlqaaHITAAAAAAA/TANBgkqhkiG
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFG4JYRGRiIvMLjAbD1Ha7Dn4
# CicjMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBho
# dHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAO9zoaFwk
# 8+q2FIz/9vPH5BxQpC+p3w13oVLDuRdNN2q0zjIord3PGD5A+g2ic0m2/k0SE3xl
# bm5OrrOfn3pmhQPh2/7bIGDQPI5l1cnc+fuTYgICRk1eXd0Kjsh8CQDfEH7HaTAA
# lvajxgSrPHkEPABgLvBTHy2JnIPSQD3vF+ji+U0uEgW9CHb7dIrWcj8tByS4+VQp
# qHGCU4q7aqJhfaL/waFtkOrwNJ+5dX6Jm1WLjZQbghKuxUgF4Yze06GHp0zgQt0a
# VUn0o/MpJxQ5sdwOJirtweScbcgjv3fb8W0hOTE8q7HGhrELzorBPnkhswSwtWAa
# vm3LMYGWC6M4VqGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3MQsw
...
# DTE5MDQwMjE5MjY0MFowIwYJKoZIhvcNAQkEMRYEFDZzddK/4laOitx8cjEXIKqr
# SoGBMA0GCSqGSIb3DQEBBQUABIIBAE9LyqizbGBL1DbX9lL3eVARAZGQ7gAzXNMH
# 9Ww8KyUs0vIajlvI11PxLVRsv6ktRPgzFCq4KIhDBKmNhWRELCxP1Nr37MUDexD1
# NsonO404IKvwHtVqFCIc9rJ9nltt8PBQMt+teZ38q1rw0vA2lsJQQ7KKcWm/gUUG
# 3zLfGgSBs2jWeEXFvuQJtArIHuOvkkDT0WHecxLiDrxUdWpBV6G+ksMMmNoBCUm1
# 9nGA377682q+HR52PFIktWgqkf6vC1nQdVOpxBP/B7JVfGiud7NTASaNj2TAHUuE
# DZ5vlwjFfQ4G6yTLuIOj0DjpBdHgV41sNTrlScLRHdwlWYt0vUE=
