...
Get-ChildItem C:\GitRepos\Windows-Sandbox\*.ps1 | ForEach-Object {. $_ }
...
# Set-ConsoleConfig -WindowHeight 45 -WindowWidth 200 | Out-Null

#--------------------
# Variables
$CompanyNumbers = Get-CompanyNumbersClass -Json ([System.IO.File]::ReadAllText('C:\GitRepos\ProfileFunctions\CompanyNos.json'))
